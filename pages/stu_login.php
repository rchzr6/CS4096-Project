...
if(isset($_POST['go'])){
	...
	$q = "SELECT * FROM `stu_member` WHERE username='$usr' AND password='$psw'  ";
	...
	if(mysqli_num_rows($res) == 1){
		...
		$_SESSION['log'] = 'in';
		$get_ID = "SELECT id FROM `stu_member` WHERE username='$usr'";
...
<br>
<a href="stu_join.php">Create Account</a><br><br>
