...
$newpass_2 = $_POST["newpass_2"];
	...
	$q = "SELECT `password` FROM `stu_member` WHERE username='".$user."'";//queries the db and gets the current password
	...
	$q= "UPDATE stu_member SET password='".$hashpass."'WHERE username='".$user."'";
	$res = mysqli_query($con,$q);
