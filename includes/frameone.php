...
if(!empty($wonum)){//prints info/headers
	echo '<b>Work Order Number:</b> <i>'.$wonum.'</i><br><b>Submitter Name:</b> <i>'.$name.'</i><br><b>Submitter Email:</b><i> '.$email.'</i><br><b>Short Description:</b><i> '.$sd.'</i>';
	echo '<br><b>Due Date:</b> <i>'.$ddate.'</i>          <b>Start Date:</b> <i>'.$sdate.'</i><br>';
}
else
