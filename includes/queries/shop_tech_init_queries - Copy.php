<?php
	...
	if(isset($_POST['me']))
		$q = "SELECT `wo_num`,`wo_submit_date`,`wo_short_description` FROM `work_orders` WHERE `assigned_name` = '$myname'";//gets work orders assigned to user
	else if(isset($_POST['group']))
		$q = "SELECT `wo_num`,`wo_submit_date`,`wo_short_description` FROM `work_orders` WHERE `assigned_group` = '$mygroup'";//gets work orders assigned to user's group
	...
	if(isset($_POST['vall']))
		$q = "SELECT `wo_num`,`wo_submit_date`,`wo_short_description` FROM `work_orders`";//gets all work orders
