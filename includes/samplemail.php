<?php
//THIS FILE HANDLES THE SENDING OF MAIL, THIS IS JUST A TEST EMAIL. USE IF SYSTEM NEEDS TO BE TESTED, CHANGE THE VARIABLES MARKED
/*
...
if(isset($_POST['submit']))
{
    ...
    */
	...
	$from_add = "siebe@siebe.us"; //<--PUT WHAT EMAIL THIS SHOULD BE SENT FROM

	$to_add = "ajs9n7@mst.edu"; //<-- put your yahoo/gmail email address here
	//edit subject and message to whatever
